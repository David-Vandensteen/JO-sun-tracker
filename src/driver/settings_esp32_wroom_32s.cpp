...
void settingsInit(Settings *settings) {
    ...
    settings->board.pin.tracker[TRACKER_1].ldr.day.up = 32;
    settings->board.pin.tracker[TRACKER_1].ldr.day.down = 33;
    settings->board.pin.tracker[TRACKER_1].ldr.night = 34;
    settings->board.pin.tracker[TRACKER_1].motors.ena = 25;
    settings->board.pin.tracker[TRACKER_1].motors.in1 = 26;
    settings->board.pin.tracker[TRACKER_1].motors.in2 = 27;
    settings->board.pin.tracker[TRACKER_1].motors.enb = 14;
    settings->board.pin.tracker[TRACKER_1].motors.in3 = 12;
    settings->board.pin.tracker[TRACKER_1].motors.in4 = 13;
